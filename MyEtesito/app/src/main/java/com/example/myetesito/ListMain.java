...
import com.example.myetesito.Basesita.BDcuenta;
...
public class ListMain extends AppCompatActivity {
    ...
    private int []imagen = { R.drawable.Imagen2600,R.drawable.editbutton,R.drawable.removebutton };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSiguiente = (Button) findViewById(R.id.buttonLSig);
